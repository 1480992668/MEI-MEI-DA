...
xhr.onreadystatechange =function(){
    if(xhr.readyState ==4&&/200|304/.text(xhr.status)){
...
function render(ary){
    let str ='';
    ary.forEach((iteam,index)=>{let {desc,pic,height,author} =item;
...
function getMinLi (){
    let ary =[...olis].sort((a,b)=>{return a.clientHeigth -b.clientHeight;})
    return aty[0];
